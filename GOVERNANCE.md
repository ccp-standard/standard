...
- When three or more independent organizations are engaged, decision-making moves to
  a shared model, and this document is rewritten by those participants rather than by
  ANKATech.
...
While there is a single author, amendments are made by that author and recorded in
`CHANGELOG.md`. Once maintainers are seated, amendment requires their agreement.
